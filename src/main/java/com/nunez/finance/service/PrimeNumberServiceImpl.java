...
@Service
@Slf4j
public class PrimeNumberServiceImpl implements PrimeNumberUseCase { // Implement the domain interface

	/**
	 * Checks if a number is prime. A prime number is a natural number greater than
