...
import com.nunez.finance.controller.TransactionController; // Corrected import
...
@WebMvcTest(controllers = TransactionController.class, classes = com.nunez.finance.FinanceApplication.class)
